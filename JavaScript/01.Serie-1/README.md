...
If you need to review some basics, you can always go back to the [JS introduction](../../../01.The-Field/09.Intro-JS/readme.md).
...
* open a terminal
* go to the folder _01.Series-1_ (in this repo)
* run `npm run api`
